# 2YStudy - Voice-First AI Training Platform

منصة تدريب ذكية لمهندسي الكهروميكانيك. تدعم العربية والإنجليزية.
...
- **GCP Project:** `gen-lang-client-0276541401` (2YStudy)
- **Region:** us-central1
...
| Role | Email | Password |
|------|-------|----------|
| Super Admin | superadmin@2ystudy.com | SuperAdmin@123! |
