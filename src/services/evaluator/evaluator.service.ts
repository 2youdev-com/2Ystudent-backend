...
const TEACHER_PROFILES: Record<AITeacherName, Omit<TeacherAssignment, 'assignmentReason'>> = {
  ahmed: {
    teacherName: 'ahmed',
    teacherDisplayName: { ar: 'Alex', en: 'Alex' },
    teacherDescription: {
      ar: 'Fundamentals Teacher - Specializes in building core skills for beginners',
      en: 'Fundamentals Teacher - Specializes in building core skills for beginners',
    },
  },
  noura: {
    teacherName: 'noura',
    teacherDisplayName: { ar: 'Emily', en: 'Emily' },
    teacherDescription: {
      ar: 'Practical Applications Teacher - Specializes in developing advanced techniques and strategies',
      en: 'Practical Applications Teacher - Specializes in developing advanced techniques and strategies',
    },
  },
  anas: {
    teacherName: 'anas',
    teacherDisplayName: { ar: 'James', en: 'James' },
    teacherDescription: {
      ar: 'Senior Technical Coach - Specializes in refining expert skills and professional excellence',
      en: 'Senior Technical Coach - Specializes in refining expert skills and professional excellence',
    },
  },
  abdullah: {
    teacherName: 'abdullah',
    teacherDisplayName: { ar: 'Robert', en: 'Robert' },
    teacherDescription: {
      ar: 'Growth Mentor - Analyzes your performance and guides you with data-driven insights',
...
export class EvaluatorService implements IEvaluatorService {
  ...
  async evaluate(input: EvaluatorInput): Promise<EvaluatorReport> {
    ...
    try {
      ...
      // 4. Build LLM prompt
      const systemPrompt = `You are Bot 5 - the AI Evaluator for an electromechanical engineering training platform.
...
Provide the evaluation JSON.`;
   ...
   * - Weak/Beginner (0-40): Noura - challenges and pushes them to improve
   * - Slightly Higher (41-60): Anas - develops their intermediate skills
   * - Higher (61-80): Ahmed - patiently teaches advanced fundamentals
  ...
  getTeacherForScore(score: number): TeacherAssignment {
    ...
    if (score <= 40) {
      ...
      teacherName = 'noura';
      reason = {
        ar: 'Based on your current level, you will work with Emily who will challenge you and push for rapid improvement',
        en: 'Based on your current level, you will work with Emily who will challenge you and push for rapid improvement',
      };
    } else if (score <= 60) {
      // Slightly Higher → Anas (develops intermediate skills)
      teacherName = 'anas';
      reason = {
        ar: 'Based on your level, you will work with James to develop your advanced engineering and technical skills',
        en: 'Based on your level, you will work with James to develop your advanced engineering and technical skills',
      };
    } else if (score <= 80) {
      // Higher → Ahmed (patiently teaches advanced fundamentals)
      teacherName = 'ahmed';
      reason = {
        ar: 'Based on your good level, you will work with Alex to polish your fundamentals and strengthen your core skills',
        en: 'Based on your good level, you will work with Alex to polish your fundamentals and strengthen your core skills',
      };
    } else {
      // Professional (81-100) → Abdullah (wise mentor, data-driven guidance)
      teacherName = 'abdullah';
      reason = {
        ar: 'Based on your excellent level, you will work with Robert the Growth Mentor for performance analysis and reaching the top',
        en: 'Based on your excellent level, you will work with Robert the Growth Mentor for performance analysis and reaching the top',
      };
    }
  ...
  private parseEvaluatorResponse(content: string): {
    ...
    try {
      ...
      return {
        skillAnalyses: [],
        overallNarrative: {
          ar: 'The system could not generate a detailed evaluation. Please try again.',
