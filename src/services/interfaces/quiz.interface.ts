...
export interface IQuizService {
  ...
  deleteQuiz(quizId: string, userId: string, userRole: string): Promise<void>;
  ...
  // Quiz taking (trainee)
  getAvailableQuizzes(courseId?: string, traineeId?: string): Promise<QuizListItem[]>;
  ...
  getStudentHistory(traineeId: string): Promise<TraineeAttemptHistoryItem[]>;

  // AI generation
  generateQuiz(creatorId: string, orgId: string | null, input: GenerateQuizInput, traineeId: string): Promise<QuizDetail>;
}
