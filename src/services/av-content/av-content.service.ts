...
const LECTURE_SYSTEM_INSTRUCTION = `You are an Electromechanical Engineering Expert creating educational video lectures.
...
{
  "title": "string",
  "titleAr": "string (same as title in English)",
  "description": "string",
  "descriptionAr": "string (same as description in English)",
  "slides": [
    {
      "slideNumber": 1,
      "title": "string",
      ...
      "bulletPointsAr": ["point 1", "point 2", "point 3"],
      "visualType": "bullets",
      "narrationText": "English narration script for this slide",
      "narrationTextAr": "Same narration in English",
      "duration": 60
    }
  ],
  "totalDuration": 300
...
1. Use professional English for all content
2. Include industry-specific standards and regulations
3. Reference international best practices and terminology
4. Each slide should have 2-4 bullet points maximum
5. Narration should be conversational but professional
6. Estimate duration at ~150 words per minute
...
const SUMMARY_SYSTEM_INSTRUCTION = `You are an electromechanical engineering expert creating interactive audio summaries for trainees.
...
export class AVContentService implements IAVContentService {
  ...
  private async generateLectureStructure(
    ...
    const prompt = `Create a ${durationMinutes}-minute educational video lecture about "${topic}" for electromechanical engineering professionals.
...
Remember to output ONLY valid JSON, no markdown.`;
  ...
  private async generateSummaryStructure(
    ...
    const prompt = `Create a 3-5 minute audio summary about "${topic}" for electromechanical engineering trainees.
