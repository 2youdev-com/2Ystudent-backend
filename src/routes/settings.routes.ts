...
router.patch('/organization', authMiddleware(['admin']), async (req: Request, res: Response) => {
  try {
    const prisma = container.resolve<PrismaClient>('PrismaClient');
    const traineeRepo = container.resolve<ITraineeRepository>('TraineeRepository');
...
router.patch('/notifications', authMiddleware(['admin']), async (req: Request, res: Response) => {
  try {
    const prisma = container.resolve<PrismaClient>('PrismaClient');
    const traineeRepo = container.resolve<ITraineeRepository>('TraineeRepository');
...
router.delete('/reset-data', authMiddleware(['admin']), async (req: Request, res: Response) => {
  try {
    const prisma = container.resolve<PrismaClient>('PrismaClient');
    const traineeRepo = container.resolve<ITraineeRepository>('TraineeRepository');
