  ...
  return (req: Request, res: Response, next: NextFunction): void => {
    try {
      ...
      if (allowedRoles && allowedRoles.length > 0) {
        ...
        // If super admin is impersonating an organization and the route allows admin,
        // grant access as if they were an admin
      ...
      // For impersonating super admins, we set role to admin for proper permission checks
      const effectiveRole =
