...
export interface IQuizRepository {
  ...
  findInProgressAttempt(traineeId: string, quizId: string): Promise<QuizAttempt | null>;
  ...
  findAttemptsByStudent(traineeId: string, quizId?: string): Promise<(QuizAttempt & { quiz: { title: string; titleAr: string | null; passingScore: number } })[]>;
