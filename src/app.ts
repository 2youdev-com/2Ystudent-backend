...
import traineeCoursesRoutes from './routes/courses.routes';
import simulationTopicsRoutes from './routes/simulation-topics.routes';
...
apiRouter.use('/trainee/courses', traineeCoursesRoutes);
apiRouter.use('/groups', groupRoutes);
apiRouter.use('/notes', notesRoutes);
apiRouter.use('/notifications', notificationsRoutes);
apiRouter.use('/settings', settingsRoutes);
apiRouter.use('/super-admin', superAdminRoutes);
apiRouter.use('/simulation-topics', simulationTopicsRoutes);
