...
export class TraineeController {
  ...
  private async getProfile(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const profile = await this.traineeService.getProfile(studentId);
  ...
  private async updateProfile(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const profile = await this.traineeService.updateProfile(studentId, input);
  ...
  private async getProgress(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const progress = await this.traineeService.getProgress(studentId, programId);
  ...
  private async getDashboardStats(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const stats = await this.traineeService.getDashboardStats(studentId);
  ...
  private async enrollInProgram(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      await this.traineeService.enrollInProgram(studentId, programId);
  ...
  private async completeLecture(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      await this.traineeService.completeLecture(studentId, lectureId, timeSpentMinutes);
  ...
  private async completeAssessment(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      await this.traineeService.completeAssessment(studentId, assessmentId, score);
  ...
  private async updateActivity(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      await this.traineeService.updateActivity(studentId, timeSpentMinutes);
  ...
  private async getStudentById(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  /**
   * Get the current assigned AI teacher for the student with full details
  ...
  private async getAssignedTeacher(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const teacherInfo = await this.traineeService.getAssignedTeacher(studentId);
